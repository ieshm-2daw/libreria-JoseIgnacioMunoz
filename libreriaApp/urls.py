...
from .views import LibroListView, LibroDetailView, LibroCreateView, LibroUpdateView, LibroDeleteView, CrearPrestamoView, DevolucionView, ListPrestamoUsuarioView, PrestamosExpiranPronto
